...
# b2$ sbatch --dependency=after:11254323:+1 job2.sh#
####################################################
...
### GLAM_OK
# [ cv2_glam_256_ok ]
# srun python main.py -m model=glam_64_ok dataset=us256 training=crop64_128_128_nnu dataset.path.pth=/scratch/lthemyr/20220318_US_DATA training.pth=/scratch/lthemyr/20220318_US_DATA model.pth=/scratch/lthemyr/20220318_US_DATA training.checkpoint.load=True dataset.cv=cv2
